...
export interface AccessibilityIconProps extends SVGProps<SVGSVGElement> {
    size?: string | number;
    absoluteStrokeWidth?: boolean;
}

/** Símbolo internacional de acessibilidade (ONU), substituindo o ícone `Accessibility` do lucide-react. */
export const AccessibilityIcon = forwardRef<SVGSVGElement, AccessibilityIconProps>(
    ({ size = 24, color = 'currentColor', absoluteStrokeWidth: _absoluteStrokeWidth, ...rest }, ref) => (
        <svg ref={ref} viewBox="0 0 1000 1000" width={size} height={size} {...rest}>
            <g fill="none" stroke={color} strokeMiterlimit="10" strokeWidth={32.8947}>
                <path d="M105.7,408.6c0,0,393.3,238.2,786.6,0" />
                <line x1="739.6" y1="876.6" x2="500" y2="520.2" />
                <line x1="260.2" y1="876.6" x2="500" y2="520.2" />
            </g>
            <g fill={color} stroke={color} strokeMiterlimit="10" strokeWidth={32.8947}>
