CREATE TABLE IF NOT EXISTS public.ai_prompts (
    ...
    CONSTRAINT fk_ai_prompts_updated_by FOREIGN KEY (updated_by) REFERENCES public.users (id) ON DELETE SET NULL
);

ALTER TABLE public.ai_prompts ENABLE ROW LEVEL SECURITY;
REVOKE ALL ON TABLE public.ai_prompts FROM anon, authenticated;

INSERT INTO public.ai_prompts (agent_key, name, description, prompt_text)
VALUES
