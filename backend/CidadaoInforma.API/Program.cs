...
using CidadaoInforma.Infrastructure.Repositories;
using CidadaoInforma.Infrastructure.Services;
...
var jwtSecret = builder.Configuration["Jwt:Secret"] ?? "SuperSecretKeyForCidadaoInformaApplication2026";
...
builder.Services.AddDbContext<CidadaoInforma.Infrastructure.Data.ApplicationDbContext>(options =>
